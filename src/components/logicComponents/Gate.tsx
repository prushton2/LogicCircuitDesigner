...
// const BaseGate = React.forwardRef(({I, pos, comp, label, image, style, id, onClick, setPos}: { //the skeleton for a logic gate. Everything minus the image and logic.
// 	I: connection[], pos: pos, label: string, image: string, style: buttonOffset, id: string,

// 	comp: (A: boolean, B: boolean) => boolean,
// 	onClick: (id: string) => void,
// 	setPos: (pos: pos, id: string) => void}, ref: any) => {
...
// export const Gate = React.forwardRef(({I, id, pos, type, onClick, setPos}: {I: connection[], pos: pos, id: string, type: string, onClick: (id: string) => void, setPos: (pos: pos, id: string) => void}, ref: any) => {
...
// 	return <BaseGate ref={ref} id={id} I={I} pos={pos} comp={compare} label={type} image={image} onClick={(id) => onClick(id)} style={style} setPos={(pos, id) => {setPos(pos, id)}}/>
// })